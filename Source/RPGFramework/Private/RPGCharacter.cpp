...
void ARPGCharacter::GetActiveAbilitiesWithTag(FGameplayTagContainer AbilityTags,
...
{
	if (!AbilitySystemComponent || !GameplayEffect) return;
...
{
	if (!AbilitySystemComponent || !GameplayEffect) return false;
